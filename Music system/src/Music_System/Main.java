...
public class Main {
    ...
    public static void main(String[] args){
     //Принимаем строку пользователя с названием музыкальной композиции
     Scanner in = new Scanner(System.in);
     String user_input=in.nextLine();
     in.close();
     //описываем характеристики каждой музыкальной композиции
     ...
     //Выводим характеристики композиции,запрашиваемой пользователем
